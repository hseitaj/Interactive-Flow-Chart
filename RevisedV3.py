...
class Ui_SecondWindow(object):
        ...
        def UpdateColorTaken(self):
                ...
                credits = 0
                buttonCredits = 0
                global totalNumberOfCredits                     #This may need to be in the if/else statement
                if line == None or line == "":
                        ...
                        if credits == buttonCredits:
                                ...
                                totalNumberOfCredits = totalNumberOfCredits + (credits - buttonCredits)
                        elif credits < buttonCredits:
                                totalNumberOfCredits = totalNumberOfCredits - buttonCredits + credits
                ...
                global congratulations
                global numberOfCredits
                print("credits added" + str(credits))
                print("total credits:" + str(totalNumberOfCredits))
